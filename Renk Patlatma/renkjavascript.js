...
(function(window){
    ...
    var Game = {
      ...
      gameOver: function(){
          ...
          this.clear();
          var message = "Oyun Bitti";
          var message2 = "Puan: " + Game.score;
          var message3 = "Tekrar oynamak için tıklayın veya SPACE tuşuna basın";
          this.pause();
      ...
      updateScore: function(){
          ...
          this.ctx.fillText("Puan: " + this.score, 8, 20);
          this.ctx.fillText("Sağlık: " + (this.maxLives - this.life), 8, 40);
      },
